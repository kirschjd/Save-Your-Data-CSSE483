...
public class BrowseAdapter extends RecyclerView.Adapter<BrowseAdapter.ViewHolder> {
    ...
    private final BrowseFragment.OnBrowseFileInteractionListener mListener;
...
//    private UUID MY_UUID = UUID.fromString("93e6dde0-f174-11e6-9598-0800200c9a66");
    ...
    public BrowseAdapter(Context context, BrowseFragment.OnBrowseFileInteractionListener listener, Query query) {
    ...
    //but could never quite get the server/client threads working properly. They would run and effectively
    //shut down the app. Perhaps another time.
...
//                    Log.d(Constants.BT_TAG, "Name: " + deviceName +
...
//    };
    ...
    public class BrowseFileEventListener implements ChildEventListener {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(this.mContext).inflate(R.layout.browse_row_view, parent, false);
        return new BrowseAdapter.ViewHolder(itemView);
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            nameTextView = (TextView) itemView.findViewById(R.id.browse_file_title);
            descriptionTextView = (TextView) itemView.findViewById(R.id.browse_file_description);
        }
    }
}
